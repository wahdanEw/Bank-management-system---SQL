/*#1*/
/*שאילתה המחזירה את ת.ז, שם ושם משפחה של כל הלקוחות
...
/*#2*/
/* שאילתה המחזירה את מספרי כל החשבונות שנמצאות ביתרת חובה
...
/*#3*/
/* שאילתה המחזירה עבור כל סניף בבנק דיסקונ ט כמה חשבונות
קיימים בו .*/
...
לקוחות הבנק שחוגגים יום הולדת באותו התאריך. שאילתה המחשבת
...
/*#5*/
/* שאילתה המחזירה את ת.ז והשם של כל הלקוחות בני פחות מ 18
...
הסניף על מנת לבחור שם. רשימת שמות ללא כפילויות של כל
הלקוחות בסניף זה*/
...
/*#07*/
/*ת.ז של הלקוחות שמנהלים חשבון גם בבנק לאומי וגם בבנק
פועלים .*/
SELECT C.cid
FROM Customer C, Account_holders AH, Banks B
...
/*#08*/
/* מספר החשבון של כל הלקוחות בסניף 13 בבנק הבינלאומי
...
/*#09*/
/* שם ומספר ת.ז של הלקוחות שמנהלים יותר מחשבון בנק אחד*/
...
/*10*/
/*שמות של הלקוחות שיש להם יתרת עו"ש הגדולה מ 15000
...
/*11*/
/*כל סניף בכל בנק את הנתונים אודות מנהל הסניף שלו, מספר
ת.ז שם ושם משפחה .*/
...
/*12*/
/* מספר הבנק ומספר הסניף שמונה יותר מ 10000 לקוחות*/
